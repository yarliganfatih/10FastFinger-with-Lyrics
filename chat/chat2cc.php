...
<body style='color:white;font-size:15px;background-color:black;'>
<div id="chatbox" class="force-overflow" STYLE=" overflow-x: hidden; overflow-y: scroll;width:300px;height: calc(100% - 40px);color:black;position:relative;">
